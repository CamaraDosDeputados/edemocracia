...
from apps.pjb.views import escola_list_view, escola_detail_view

base_url_edemocracia = settings.BASE_URL_EDEMOCRACIA.lstrip('/')

urlpatterns = [
    path(base_url_edemocracia + '', index, name='home'),
    path(base_url_edemocracia + 'escola/list',
         escola_list_view, name='escola-list'),
    path(base_url_edemocracia + 'escola/<int:id>/detail',
         escola_detail_view, name='escola-detail'),
