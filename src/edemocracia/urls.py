...
from apps.pjb.views import deputado_list_view, deputado_detail_view, \
     ...
     comissao_list_view, mesa_diretora_view, partido_list_view, partido_detail_view
...
urlpatterns = [
    ...
    path(base_url_edemocracia + 'partido/<int:id>/detail',
         partido_detail_view, name='partido-detail'),
    path(base_url_edemocracia + 'partidos/list',
         partido_list_view, name='partidos-list'),
